...
if (isset($_POST['submit_comment'])) {
    if ($_POST['comment'] !== "") {
        save_comment($cur_id, $cur_id, explode(";", $_COOKIE['Cookie'])[1], $_POST['comment']);
    }
}

$all_cmt = get_all_comment_of_profile($cur_id);

if (isset($_POST['updateInfor'])) {
    if (strtolower($_POST['username']) === strtolower($cur_username)) {
        if ($role === '2') {
            teacher_role_edit_profile($cur_id, $_POST['name'], $_POST['sex'], $_POST['mobile'], $_POST['email'], $_POST['address'], $_POST['username']);
            header("Location: ./profile.php");
        } else {
            student_role_edit_profile($cur_id, $_POST['sex'], $_POST['mobile'], $_POST['email'], $_POST['address']);
            header("Location: ./profile.php");
        }
    } else {
...
if (isset($_POST['change_pass'])) {
    $errors = array();
    $old_pass = explode(";", $_COOKIE['Cookie'])[2];
    $old_pass_entered = hash('sha256', $_POST['password0']);
    $new_pass_1 = hash('sha256', $_POST['password1']);
    $new_pass_2 = hash('sha256', $_POST['password2']);

    if ($old_pass !== $old_pass_entered) {
        $errors['old_pass'] = '<br><span style="color:#FF0000;">Wrong password, please try again.</span>';
    }
    if ($new_pass_1 !== $new_pass_2) {
        $errors['new_pass'] = '<br><span style="color:#FF0000;">Password mismatch, please try again.</span>';
    }
    if (!$errors) {
        $result = change_pass($cur_id, $new_pass_1);
        $tmp = $cur_id . ";" . $cur_username . ";" . $new_pass_1;
        ...
        header("Refresh:4; Location: ./profile.php");
    }
}
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container bootstrap snippet">
            <div style="margin-bottom: 30px;text-align: center;"><h1>User profile</h1></div>
            <div class="row">
                ...
                <div class="col-sm-9">
                    <ul class="nav nav-tabs">
                        ...
                        ?>"><a data-toggle="tab" href="#home">Your Profile</a></li>
                        ...
                        ?>"><a data-toggle="tab" href="#settings">Change password</a></li>
                    ...
                    <div class="tab-content">
                            ...
                            <form class="form" method="post" id="registrationForm">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <input type="text" class="form-control" name="username" id="username" placeholder="Enter your username" 
                                               title="Enter your username." value= "<?php echo $user['user_username']; ?>" 
                                               <?php if ($role === '3') { ?> readonly <?php } ?> required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <input type="text" class="form-control" name="name" id="user_name" placeholder="Enter your name" 
                                               title="Enter your name." value= "<?php echo $user['user_name']; ?>"
                                               <?php if ($role === '3') { ?> readonly <?php } ?> required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-6">
                                        ...
                                        <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Enter phone number" title="Enter your phone number." value= "<?php echo $user['user_mobile']; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-6">
                                        <label for="email"><br><h4>Email</h4></label>
                                        <input type="email" class="form-control" name="email" id="email" placeholder="someone@example.com" title="Enter your email." value= "<?php echo $user['user_email']; ?>" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-6">
                                        ...
                                        <input type="Text" class="form-control" name="address" id="location" placeholder="Enter your address" title="Enter a location" value= "<?php echo $user['user_address']; ?>" required>
                                    </div>
                                </div>
                        ...
                        ?>" id="settings" >
                            <hr>
                            <form style="margin-left: 50px; width:50%;" class="form" method="post" id="registrationForm">
                                <div class="form-group">

                                    <div class="col align-self-center">
                                        <label for="first_name"><h4>Old password</h4></label>   
                                        <input type="password" class="form-control" name="password0" id="password0" placeholder="Old password" title="Enter your old password." required>
                                        <?php if (!empty($errors['old_pass'])) echo $errors['old_pass']; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">           
                                    ...
                                    <div class="col align-self-center">
                                        ...
                                        <input type="password" class="form-control" name="password1" id="password1" placeholder="New password" title="Enter your new password." required>
                                        <?php if (!empty($errors['new_pass'])) echo $errors['new_pass']; ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col align-self-center">
                                        ...
                                        <input type="password" class="form-control" name="password2" id="password2" placeholder="Re-enter new password" title="Re-enter your password." required>
                                        <?php if (!empty($errors['new_pass'])) echo $errors['new_pass']; ?>
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <br>
                                        <button class="btn btn-lg btn-success pull-right" name="change_pass" type="submit"><i class="glyphicon glyphicon-ok-sign"></i> Save</button>
                                        <button class="btn btn-lg" type="reset"><i class="glyphicon glyphicon-repeat"></i> Reset</button>
                                    </div>
                                </div>
                            </form>
